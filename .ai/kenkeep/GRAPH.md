---
schema_version: 3
nodes_hash: 'sha256:dae27c4e04952eeb2c349d7bf908adf50459cef2cabcc8552aa68a92e7cc649e'
node_count: 86
---
# kenkeep Graph
...
- **kind:** map
- **title:** Dalia UI design system: vendored into src/web/vendor/, not a package dependency
- **path:** web/styling/map-dalia-ui-design-system-vendored-into-src-web-vendor-not-a-package-dependency.md
- **tags:** web, spa, dalia, design-system

## map-docs-config-yml-controls-github-pages-baseurl-for-the-jekyll-docs-site
...
- **path:** dev/map-npm-run-dev-serve-ts-node-backend-hot-reload-script.md
- **tags:** web, serve, scripts, dev
...
- **path:** skills/map-skills-are-auto-loaded-by-intent-matching-not-slash-command-prefix.md
- **tags:** skills, invocation, harness
...
- **path:** web/styling/map-spa-vendor-styles-five-retained-css-files-under-src-web-vendor-styles.md
- **tags:** spa, styles, tailwind, tokens, vendor
...
- **kind:** map
- **title:** src/__tests__/fixtures/serve-workspace/ — committed fixture workspace for tests
...
- **path:** web/editor/practice-all-codemirror-packages-must-stay-in-devdependencies-and-be-imported-lazily.md
- **tags:** codemirror, spa, devdependencies, lazy-loading

## practice-always-dark-surfaces-need-explicit-dark-mode-color-fixups-when-using-dual-purpos

- **kind:** practice
- **title:** Always-dark surfaces need explicit dark-mode color fixups when using dual-purpose tokens
- **path:** web/styling/practice-always-dark-surfaces-need-explicit-dark-mode-color-fixups-when-using-dual-purpos.md
- **tags:** dark-mode, css, tokens, theming
- **relates_to:** practice-vendoring-dalia-css-requires-the-foundational-dark-token-block-not-just-per-component-fixups
...
- **path:** git/practice-commit-subject-50-chars-body-wrapped-at-72-chars-hook-enforced.md
...
- **path:** release/practice-do-not-commit-agents-skills-or-skills-lock-json-they-are-local-installation-artifacts.md
...
- **kind:** practice
- **title:** Isolate concurrent-agent changes before committing by excluding entangled files from staging
- **path:** git/practice-isolate-concurrent-agent-changes-before-committing-by-excluding-entangled-files.md
- **tags:** git, concurrent-agents, staging, pre-commit
- **relates_to:** practice-do-not-use-no-verify-to-skip-git-commit-hooks
...
- **path:** git/practice-lint-staged-scopes-lint-format-but-pre-commit-still-runs-the-full-test-suite.md
- **tags:** linting, tooling, eslint, prettier, pre-commit
- **relates_to:** practice-pre-commit-test-hook-prevents-per-phase-commits-during-multi-phase-plan-execution
...
- **path:** serve/practice-plan-detail-blueprint-markdown-vs-tasks-frontmatter.md
...
- **path:** testing/practice-playwright-e2e-suites-flake-under-full-suite-parallelism-due-to-cpu-contention.md
...
- **path:** web/rendering/practice-set-suppresserrorrendering-true-in-mermaid-initialization.md
- **tags:** mermaid, spa, rendering, error-handling
...
- **path:** dev/practice-spa-source-changes-require-npm-run-build-web-before-serve-reflects-them.md
- **tags:** spa, build, serve, dev-workflow
- **relates_to:** practice-hot-reload-dev-loop-requires-three-concurrent-processes

## practice-src-web-vendor-and-dist-web-are-excluded-from-prettier-formatting
...
- **path:** dev/practice-start-or-reuse-dev-serve-instance-to-visually-debug-the-spa.md
...
- **path:** web/ui/practice-use-baseui-components-for-interactive-ui-elements-in-the-spa.md
...
- **kind:** practice
- **title:** Use @theme token utilities everywhere in the SPA; never arbitrary-value brackets for design values
- **path:** web/styling/practice-use-theme-token-utilities-everywhere-in-the-spa-never-arbitrary-value-brackets-f.md
- **tags:** tailwind, tokens, css, dark-mode, spa

## practice-vendoring-dalia-css-requires-the-foundational-dark-token-block-not-just-per-component-fixups

- **kind:** practice
- **title:** Dark mode requires both the foundational .dark token block and per-component fixups, both in tokens.css
