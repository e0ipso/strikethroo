...
tags:
  ...
  - debugging
kk_schema_version: 3
kk_id: practice-start-or-reuse-dev-serve-instance-to-visually-debug-the-spa
kk_derived_from: []
kk_relates_to:
...
- Related: [map-npm-run-dev-serve-ts-node-backend-hot-reload-script](/dev/map-npm-run-dev-serve-ts-node-backend-hot-reload-script.md)
