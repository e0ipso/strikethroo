...
var writeExecutionProfileFrontmatter = (taskMarkdown, profile) => {
...
var usage = () => emit(
  {
    ...
    detail: "Usage: route-task-execution.cjs profiles <plan-id> | route-task-execution.cjs apply <plan-id> <assignment-json-file>"
  },
  2
);
